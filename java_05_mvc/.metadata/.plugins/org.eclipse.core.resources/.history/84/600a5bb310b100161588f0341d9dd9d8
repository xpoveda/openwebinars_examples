...
public class Country {
     ...
     * @param population
     */
    public Country(String name, List<String> topLevelDomain, String alpha2Code, String alpha3Code, List<String> callingCodes, String capital, List<String> altSpellings, String relevance, String region, String subregion, Translations translations, Integer population, List<Integer> latlng, String demonym, Integer area, Double gini, List<String> timezones, List<String> borders, String nativeName, String numericCode, List<String> currencies, List<String> languages) {
        this.name = name;
